const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-DiAGj7zo.js","assets/main-DPytHhfj.css"])))=>i.map(i=>d[i]);
import{_ as x,G as g}from"./main-DiAGj7zo.js";const L=new g(void 0),U=L.getGenerativeModel({model:"gemini-2.5-flash",generationConfig:{maxOutputTokens:4096,responseMimeType:"application/json"}});function h(c){const n=new Uint8Array(c);let e="";for(let a=0;a<n.byteLength;a++)e+=String.fromCharCode(n[a]);return btoa(e)}function j(c){if(c.type)return c.type;const n=c.name.toLowerCase();return n.endsWith(".pdf")?"application/pdf":n.endsWith(".png")?"image/png":n.endsWith(".jpg")||n.endsWith(".jpeg")?"image/jpeg":n.endsWith(".webp")?"image/webp":"application/pdf"}const F=`Você é um especialista em documentos veiculares brasileiros. Analise este ATPV-e (Autorização para Transferência de Propriedade de Veículo Eletrônico) e extraia os dados.
...
Se um campo não existir no documento, deixe a string vazia "". Não invente dados.`;async function y(c){var r,d,m,u,D,I,E,C,l,s,R;const{extractVehicleData:n}=await x(async()=>{const{extractVehicleData:A}=await import("./main-DiAGj7zo.js").then(p=>p.p);return{extractVehicleData:A}},__vite__mapDeps([0,1])),e=await n(c),a=A=>typeof A=="string"?A.trim():"",i=A=>{const p=A.match(/^(\d{2})\/(\d{2})\/(\d{4})$/);return p?`${p[3]}-${p[2]}-${p[1]}`:A},o=a(((r=e.comprador)==null?void 0:r.cpfCnpj)||e.cpfCnpjAdquirente||e.cpfCnpj).replace(/\D/g,""),t=a(((d=e.vendedor)==null?void 0:d.cpfCnpj)||e.cpfCnpjVendedor).replace(/\D/g,"");return{tipoServicoFolha:a(e.tipoServicoDetectado),placa:a(e.placa),chassi:a(e.chassi),renavam:a(e.renavam),valorRecibo:a(e.valorRecibo),dataAquisicao:i(a(e.dataAquisicao)),municipioEmplacamento:a((m=e.comprador)==null?void 0:m.municipio),comprador:{nome:a(((u=e.comprador)==null?void 0:u.nome)||e.nomeAdquirente||e.nomeProprietario),cpfCnpj:o,tipoCpfCnpj:o.length>11?"CNPJ":"CPF",rg:"",orgaoExpedidor:"",uf:a((D=e.comprador)==null?void 0:D.uf),endereco:a((I=e.comprador)==null?void 0:I.endereco),numero:a((E=e.comprador)==null?void 0:E.numero),cep:a((C=e.comprador)==null?void 0:C.cep),bairro:a((l=e.comprador)==null?void 0:l.bairro),municipio:a((s=e.comprador)==null?void 0:s.municipio)},vendedor:{nome:a(((R=e.vendedor)==null?void 0:R.nome)||e.nomeVendedor),cpfCnpj:t,tipoCpfCnpj:t.length>11?"CNPJ":"CPF"},veiculo:{tipo:a(e.tipo),marcaModelo:a(e.marcaModelo),anoFabricacao:a(e.anoFabricacao),anoModelo:a(e.anoModelo),cor:a(e.cor),combustivel:a(e.combustivel)}}}async function G(c,n,e,a=3){for(let i=1;i<=a;i++)try{return(await U.generateContent([{inlineData:{data:c,mimeType:n}},{text:e}])).response.text()}catch(o){const t=(o==null?void 0:o.message)||"";if((t.includes("429")||t.includes("503"))&&i<a){const r=t.match(/retry in (\d+)/i),d=r?Math.min(parseInt(r[1],10)+2,60):20;console.log(`[Matilde] Gemini rate limit, tentativa ${i}/${a}. Aguardando ${d}s...`),await new Promise(m=>setTimeout(m,d*1e3));continue}throw o}throw new Error("Gemini: máximo de tentativas excedido")}async function w(c){var E,C,l,s,R,A,p,N,T,M,P,f,v,S,b,V;const n=await c.arrayBuffer(),e=h(n),a=j(c),i=await G(e,a,F);let o;try{const O=i.match(/\{[\s\S]*\}/);o=JSON.parse(O?O[0]:i)}catch{throw new Error(`Gemini retornou resposta inválida: ${i.slice(0,200)}`)}const t=(o.tipoDocumento||"").toLowerCase().trim();if(t&&t!=="atpve"){const O={crlv:"CRLV",outro:"documento desconhecido"};throw new Error(`Documento inválido: este é um ${O[t]||t}, não um ATPV-e. Anexe um ATPV-e para transferência.`)}const r=O=>O&&O!==""?O:void 0,d={nome:r((E=o.comprador)==null?void 0:E.nome),cpfCnpj:r((C=o.comprador)==null?void 0:C.cpfCnpj),municipio:r((l=o.comprador)==null?void 0:l.municipio),uf:r((s=o.comprador)==null?void 0:s.uf),cep:r((R=o.comprador)==null?void 0:R.cep),endereco:r((A=o.comprador)==null?void 0:A.endereco),numero:r((p=o.comprador)==null?void 0:p.numero),bairro:r((N=o.comprador)==null?void 0:N.bairro)},m={nome:r((T=o.vendedor)==null?void 0:T.nome),cpfCnpj:r((M=o.vendedor)==null?void 0:M.cpfCnpj),municipio:r((P=o.vendedor)==null?void 0:P.municipio),uf:r((f=o.vendedor)==null?void 0:f.uf)},u=r((v=o.comprador)==null?void 0:v.tipoCpfCnpj)||((((S=d.cpfCnpj)==null?void 0:S.replace(/\D/g,"").length)??0)<=11?"CPF":"CNPJ"),D=r((b=o.vendedor)==null?void 0:b.tipoCpfCnpj)||((((V=m.cpfCnpj)==null?void 0:V.replace(/\D/g,"").length)??0)<=11?"CPF":"CNPJ");return{tipoDocumento:"atpve",placa:r(o.placa),renavam:r(o.renavam),chassi:r(o.chassi),marcaModelo:r(o.marcaModelo),anoFabricacao:r(o.anoFabricacao),anoModelo:r(o.anoModelo),cor:r(o.cor),numeroCRV:r(o.numeroCRV),codigoSegurancaCRV:r(o.codigoSegurancaCRV),numeroATPVe:r(o.numeroATPVe),hodometro:r(o.hodometro),dataAquisicao:r(o.dataAquisicao),valorRecibo:r(o.valorRecibo),comprador:d,vendedor:m,cpfCnpj:d.cpfCnpj,nomeAdquirente:d.nome,cpfCnpjAdquirente:d.cpfCnpj,nomeVendedor:m.nome,cpfCnpjVendedor:m.cpfCnpj,ufOrigem:m.uf,tipoCpfCnpjComprador:u,tipoCpfCnpjVendedor:D,tipoServicoDetectado:"transferencia",textoCompleto:i}}export{w as extrairDadosATPVeComIA,y as extrairDecalqueChassi};
