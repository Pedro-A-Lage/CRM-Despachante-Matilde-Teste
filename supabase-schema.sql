...
CREATE TABLE IF NOT EXISTS ordens_de_servico (
    ...
    pdf_detran_url TEXT,
    pdf_detran_name TEXT,
    crlv_consulta JSONB DEFAULT NULL,
    observacao_geral TEXT,
    prioridade TEXT,
    pendencia TEXT,
    desconto NUMERIC DEFAULT 0,
    total_previsto NUMERIC(10,2) DEFAULT 0,
    total_pago NUMERIC(10,2) DEFAULT 0,
    saldo_pendente NUMERIC(10,2) DEFAULT 0,
    transferencia JSONB DEFAULT NULL,
    primeiro_emplacamento JSONB,
    status_delegacia TEXT,
    criado_em TIMESTAMPTZ NOT NULL DEFAULT now(),
    atualizado_em TIMESTAMPTZ NOT NULL DEFAULT now()
);
