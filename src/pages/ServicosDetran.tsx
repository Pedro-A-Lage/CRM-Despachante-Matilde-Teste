...
import { ExternalLink, RefreshCw, FileBadge, FileText, AlertCircle, XCircle, Settings, Wrench } from 'lucide-react';
...
const SERVICES: DetranService[] = [
    {
        ...
        description: 'Emissão da taxa DAE para transferência de propriedade.',
    ...
    },
    {
        ...
        description: 'Emissão de segunda via do recibo de compra e venda.',
