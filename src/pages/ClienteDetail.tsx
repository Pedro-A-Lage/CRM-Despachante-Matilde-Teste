...
import { getCliente, getVeiculosByCliente, getOrdensByCliente, updateCliente } from '../lib/storage';
        ...
        <div>
                                            ...
                                            {veiculoOrdens.map((os) => (
                                                ...
                                                >
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="text-xs text-gray">— {TIPO_SERVICO_LABELS[os.tipoServico]}</span>
                                                    </div>
            ...
            <div className="card">
                <div className="card-header">
                    ...
                    <Link to={`/ordens/nova?clienteId=${id}`} className="btn btn-secondary btn-sm">
